...
export const ALL_MODELS = [
  ...
  { alias: "sonnet", label: "Sonnet 4.5", description: "Best for everyday tasks", modelId: "claude-sonnet-4-5" },
  { alias: "opus", label: "Opus 4.5", description: "Most capable for complex work", modelId: "claude-opus-4-5" },
  { alias: "haiku", label: "Haiku 4.5", description: "Fastest for quick answers", modelId: "claude-haiku-4-5" },
];
...
export async function probeModels(client) {
  ...
  if (availableModels.length === 0) {
    console.log("No models passed probe (IAM/quota restriction?). Falling back to full model list.");
    return ALL_MODELS;
  }
